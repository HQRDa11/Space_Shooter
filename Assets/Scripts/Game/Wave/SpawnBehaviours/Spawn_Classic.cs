...
public class Spawn_Classic : SpawnBehaviour
{
    ...
    {
        GameObject gameObject1 = Factory.Instance.Enemy_Factory.CreateEnemy(wave.SpawnPoint, wave.AllEnemies.Count + 1, wave, wave.EnemyInstanceClock, ((int)EnemyType.Basic), ((int)BasicEnemy.Sample));
        ...
        if (wave.Mirror)
        {
            GameObject gameObject = Factory.Instance.Enemy_Factory.CreateEnemy(wave.SpawnPoint * new Vector2(-1, 1), wave.AllEnemies.Count + 1, wave, wave.EnemyInstanceClock, ((int)EnemyType.Basic), ((int)BasicEnemy.Sample));
